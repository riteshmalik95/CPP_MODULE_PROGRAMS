...
{
	Employee::display();
	cout<<"Employee id="<<Employee::getId()<<" hours="<<hours<<" rate="<<rate<<" salary="<<salary()<<endl;
}
...
void SalesEmployee::display()
{
	...
	cout<<"Employee id="<<Employee::getId()<<" hours="<<wageEmployee::getHours()<<" rate="<<wageEmployee::getRate()<<" sales="<<sales<<" comm="<<comm<<" salary="<<salary()<<endl;
}

int main()
{
	SalesEmployee *sptr= new SalesEmployee(101,8,500,2000,2);
